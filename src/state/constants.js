...
export const ONBOARD_FORM_COMPLETE = 'ONBOARD_FORM_COMPLETE';

export const SHOW_HOME_SCREEN_LOADER = 'SHOW_HOME_SCREEN_LOADER';
export const HIDE_HOME_SCREEN_LOADER = 'HIDE_HOME_SCREEN_LOADER';

export const TOP_LEVEL_NAVIGATION_KEY = 'topLevelNavigation'
